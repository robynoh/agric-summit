...
if(empty($_POST['name']))$message=errorMsg('Please enter username');
	...
	(ExecuteQuery("update account set name='".addslashes($_POST['name'])."', email='".addslashes($_POST['email'])."', password='".$enc_password."', acctype ='".$_POST['acctype']."' where account_id='".$rows_Edit['account_id']."'"));
	
	header("location:account_edit?id=".$_GET['id']);
