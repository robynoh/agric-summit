...
if(isset($_GET['id'])){
	...
	$resultEdit=ExecuteQuery("select * from attend where id='".$_GET['id']."'");
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Full Information</div>
                            </div>
						...
						<fieldset>
							<?php echo $message;?>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="name" data-required="1" class="span6 m-wrap" value="<?php echo $rows_Edit['name'];?>" disabled />
  								</div>
  							</div>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="email" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['phone'];?>" disabled />
  								</div>
  							</div>
                            <div class="control-group">
  								<label class="control-label">Sex<span class="required">*</span></label>
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['sex'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['work'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['position'];?>" disabled />
  								</div>
  							</div>
							
							<div class="control-group">
  								<label class="control-label">Reason to Attend<span class="required">*</span></label>
  								<div class="controls">
  									<textarea class="span6 m-wrap" disabled><?php echo $rows_Edit['reason'];?></textarea>
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['address'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['state'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['country'];?>" disabled />
  								</div>
  							</div>
  							...
  							<div class="form-actions">
  								...
  								<a href="attenders" class="btn">Go Back</a>
  							</div>
						</fieldset>
					</form>
					<!-- END FORM-->
