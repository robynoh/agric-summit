...
if(isset($_GET['id'])){
	...
	$resultEdit=ExecuteQuery("select * from exhibitors where id='".$_GET['id']."'");
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="title" data-required="1" class="span6 m-wrap" value="<?php echo $rows_Edit['title'];?>" disabled />
  								</div>
  							</div>
  							...
  							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="name" data-required="1" class="span6 m-wrap" value="<?php echo $rows_Edit['fullname'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['businessName'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input name="password" type="text" class="span6 m-wrap" value="<?php echo $rows_Edit['businessArea'];?>" disabled />
  								</div>
  							</div>
							...
							<div class="control-group">
  							...
  							<div class="form-actions">
  								...
  								<a href="exhibits" class="btn">Go Back</a>
  							</div>
						</fieldset>
					</form>
					<!-- END FORM-->
