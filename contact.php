...
<?php include('includes/header.php'); ?>
 ...
 <br/>
                        ...
                        <div class="about-two__box">
                                        <h3><i class="azino-icon-confirmation"></i> For further enquiries</h3>
                                        <p> <b>Call:</b> +23408166183754,+2348037062729</p>
<br/>

 <h3><i class="azino-icon-confirmation"></i> For technical support</h3>
                                        <p> <b>Call:</b> +2348037419240,+2348037428926</p>
<br/>
                     ...
                     <div class="col-md-12 col-lg-4">
                       ...
                       <br/>
                        <div class="contact-page__content mb-40">
                            ...
                            <p class="block-text mb-30 pr-10">Feel free to contact us. The following numbers are on standard-by for your assistance. </p>
