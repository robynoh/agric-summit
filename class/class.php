...
class connection{
	...
	public function connectTodatabase(){
        ...
        $msg=urlencode(ucwords($name).", ".$message);
		 $url='https://www.bulksmsnigeria.com/api/v1/sms/create?api_token=ZR3eJEIlCdsHh3mcchZy38OX20qNzlpyklN4ZfBTjbNgQZTRZ0yJiwzaOqX2&from=AGRICSUMMIT&to='.urlencode($phone).'&body='.$msg.'&dnd=2';
	...
	function CURLsendsmsresend($phone,$name,$message){ 
	...
	function CURLsendsms2($phone,$name){ 
        ...
        $msg=urlencode(ucwords($name).", This is to confirm your registeration to be an exhibitor in the Bayelsa 2021 Agric Summit.");
		 $url='https://www.bulksmsnigeria.com/api/v1/sms/create?api_token=ZR3eJEIlCdsHh3mcchZy38OX20qNzlpyklN4ZfBTjbNgQZTRZ0yJiwzaOqX2&from=AGRICSUMMIT&to='.urlencode($phone).'&body='.$msg.'&dnd=2';
       // $url='https://smsexperience.com/api/sms/sendsms?username=michaelodikeme&password=smsexperience&sender=dspz_cbt&recipient='.urlencode($phone).'&message='.$msg;
         $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, $url);
	...
	function CURLsendsms4($phone,$name){ 
 
        $msg=urlencode(ucwords($name).", Your registeration to be part of the Bayelsa 2021 Agric Summit is noted. Thank you.");
		 $url='https://www.bulksmsnigeria.com/api/v1/sms/create?api_token=ZR3eJEIlCdsHh3mcchZy38OX20qNzlpyklN4ZfBTjbNgQZTRZ0yJiwzaOqX2&from=AGRICSUMMIT&to='.urlencode($phone).'&body='.$msg.'&dnd=2';
       // $url='https://smsexperience.com/api/sms/sendsms?username=michaelodikeme&password=smsexperience&sender=dspz_cbt&recipient='.urlencode($phone).'&message='.$msg;
         $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, $url);
	...
	public function url(){
	 ...
	 $path="http://localhost/agricsummit/";
	 return $path;
 } 
